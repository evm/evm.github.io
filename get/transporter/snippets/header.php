    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark d-block d-md-none col-sm-12">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="my-transports.php">My Transports</a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="transporter.php">My Profile</span></a>
          </li>
<!--           <li class="nav-item">
          ...
          <hr>
          <li class="nav-item active">
            <a class="nav-link" href="index.php">Log out</span></a>
          </li>
        </ul>
      </div>
  </nav>
...
<!--           <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="my-transports.php">
              <span data-feather="file"></span>
              My Transports
              <span class="badge badge-primary">1</span>
            </a>
          ...
          <li class="nav-item">
            <a class="nav-link" href="transporter.php">
              <span data-feather="file"></span>
              My Profile
            </a>
          </li>
