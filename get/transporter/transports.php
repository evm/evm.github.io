      ...
      <div class="btn-group">
        <div class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <a class="dropdown-item" href="#">Best bid</a>
            <a class="dropdown-item" href="#">Not best bid</a>            
            <a class="dropdown-item" href="#">Lost bids</a>            
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-6">              
              <div class="bd-callout bd-callout-warning">
                <div class="row">
                  <div class="col">
                    <span class="badge badge-warning">Best bid: (15 Feb 13:03)</span>
                  </div>
                  <div class="col">
